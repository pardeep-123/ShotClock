...
class VideoGroupCallActivity : BaseActivity(), SocketManager.Observer {
    private lateinit var binding: ActivityVideoGroupBinding
    var channelName = ""
    var name = ""
...
//        activateReceiverListenerSocket()
    ...
    fun onLocalVideoMuteClick(view: View) {
        ...
        val container = findViewById<View>(R.id.local_video_view_contain) as FrameLayout
    ...
    fun onSwitchCameraClick(view: View) {
...
//      mRtcEngine!!.setVideoProfile(Constants.VIDEO_PROFILE_360P, false) // Earlier than 2.3.0
    ...
    private fun setupLocalVideo() {
        ...
        val container = findViewById<FrameLayout>(R.id.local_video_view_contain)
...
//        rl_calling.visibility = View.GONE
        ...
        val container = findViewById<View>(R.id.remote_video_view_contain) as FrameLayout
